...
namespace UnityEditor.U2D.Sprites
{
    ...
    public struct EditCapability
    {
        ...
        /// </summary>
        public static EditCapability defaultCapability = new EditCapability() { m_Capability = EEditCapability.All };
    ...
    public enum EEditCapability
    {
        ...
        All = EditSpriteRect | EditBorder | EditPivot | EditSpriteName | CreateAndDeleteSprite
    }
}
