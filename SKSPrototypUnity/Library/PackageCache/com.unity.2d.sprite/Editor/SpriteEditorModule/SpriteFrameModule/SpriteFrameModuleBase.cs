...
namespace UnityEditor.U2D.Sprites
{
    ...
    internal abstract partial class SpriteFrameModuleBase : SpriteEditorModuleModeSupportBase
    {
        ...
        public override void OnModuleActivate()
        {
            ...
            SetEditingCapabilityUI(m_CurrentEditEditCapability.data);
            RegisterEditingCapabilityChangedCallback(OnEditCapabilityChanged);
        ...
        void InitEditCapabilityUndoObject()
        {
            ...
            var frameEditCapability = GetDataProvider<ISpriteFrameEditCapability>();
            var capability = frameEditCapability?.GetEditCapability() ??EditCapability.defaultCapability;
        ...
        public override void OnModuleDeactivate()
        {
            ...
            UnregisterEditingCapabilityChangedCallback(OnEditCapabilityChanged);
